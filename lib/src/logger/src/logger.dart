...
class Logger {
  ...
  /// Log a message at level [Level.finest].
  void v(
    dynamic message, {
    DateTime? time,
    Object? error,
  ...
  /// Log a message at level [Level.finer].
  void t(
    dynamic message, {
    DateTime? time,
    Object? error,
    ...
    log(Level.finer, message, time: time, error: error, stackTrace: stackTrace);
  }
  ...
  void d(
    ...
    log(Level.fine, message, time: time, error: error, stackTrace: stackTrace);
  }
  ...
  void e(
    ...
    log(Level.severe, message, time: time, error: error, stackTrace: stackTrace);
  }
  ...
  /// Log a message at level [Level.shout].
  void f(
    dynamic message, {
    DateTime? time,
    Object? error,
    ...
    log(Level.shout, message, time: time, error: error, stackTrace: stackTrace);
  }
